...
$pix_options = array(
	...
	array(
		'name' 	=> 	esc_html__( 'Choose Options', 'product-woo-configurator' ),
		'desc' 	=> 	esc_html__( 'Type the options separated with commas{ inspiration,screenshot,reset }', 'product-woo-configurator' ),
		'id'	=>	'options',
		'std'	=>	'inspiration,screenshot,reset',
		'type'	=>	'text'
	),
